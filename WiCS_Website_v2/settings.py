"""
Django settings for WiCS_Website_v2 project.
...
ROOT_URLCONF = 'WiCS_Website_v2.urls'
...
WSGI_APPLICATION = 'WiCS_Website_v2.wsgi.application'
...
# Use these settings when running the site in the development server
